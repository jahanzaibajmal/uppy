...
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var _extends=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var i=arguments[e];for(var r in i)Object.prototype.hasOwnProperty.call(i,r)&&(t[r]=i[r])}return t},AuthView=require("./AuthView"),Browser=require("./Browser"),LoaderView=require("./Loader"),Utils=require("../core/Utils");module.exports=function(){function t(e,i){_classCallCheck(this,t),this.plugin=e,this.Provider=e[e.id];var r={viewType:"list"};this.opts=_extends({},r,i),this.addFile=this.addFile.bind(this),this.filterItems=this.filterItems.bind(this),this.filterQuery=this.filterQuery.bind(this),this.toggleSearch=this.toggleSearch.bind(this),this.getFolder=this.getFolder.bind(this),this.getNextFolder=this.getNextFolder.bind(this),this.logout=this.logout.bind(this),this.handleAuth=this.handleAuth.bind(this),this.handleDemoAuth=this.handleDemoAuth.bind(this),this.sortByTitle=this.sortByTitle.bind(this),this.sortByDate=this.sortByDate.bind(this),this.isActiveRow=this.isActiveRow.bind(this),this.handleError=this.handleError.bind(this),this.handleScroll=this.handleScroll.bind(this),this.render=this.render.bind(this)}return t.prototype.updateState=function(t){var e,i=this.plugin.stateId,r=this.plugin.core.state;this.plugin.core.setState((e={},e[i]=_extends({},r[i],t),e))},t.prototype._updateFilesAndFolders=function(t,e,i){var r=this;this.plugin.getItemSubList(t).forEach(function(t){r.plugin.isFolder(t)?i.push(t):e.push(t)}),this.updateState({folders:i,files:e})},t.prototype.getFolder=function(t,e){var i=this;return this._loaderWrapper(this.Provider.list(t),function(r){var n=[],s=[],o=void 0,l=i.plugin.core.getState()[i.plugin.stateId],a=l.directories.findIndex(function(e){return t===e.id});o=-1!==a?l.directories.slice(0,a+1):l.directories.concat([{id:t,title:e||i.plugin.getItemName(r)}]),i._updateFilesAndFolders(r,s,n),i.updateState({directories:o})},this.handleError)},t.prototype.getNextFolder=function(t){var e=this.plugin.getItemRequestPath(t);this.getFolder(e,this.plugin.getItemName(t))},t.prototype.addFile=function(t){var e=this,i={source:this.plugin.id,data:this.plugin.getItemData(t),name:this.plugin.getItemName(t)||this.plugin.getItemId(t),type:this.plugin.getMimeType(t),isRemote:!0,body:{fileId:this.plugin.getItemId(t)},remote:{host:this.plugin.opts.host,url:this.plugin.opts.host+"/"+this.Provider.id+"/get/"+this.plugin.getItemRequestPath(t),body:{fileId:this.plugin.getItemId(t)}}};Utils.getFileType(i).then(function(r){Utils.isPreviewSupported(r[1])&&(i.preview=e.plugin.getItemThumbnailUrl(t)),e.plugin.core.log("Adding remote file"),e.plugin.core.emitter.emit("core:file-add",i)})},t.prototype.logout=function(){var t=this;this.Provider.logout(location.href).then(function(t){return t.json()}).then(function(e){if(e.ok){var i={authenticated:!1,files:[],folders:[],directories:[]};t.updateState(i)}}).catch(this.handleError)},t.prototype.filterQuery=function(t){var e=this.plugin.core.getState()[this.plugin.stateId];this.updateState(_extends({},e,{filterInput:t.target.value}))},t.prototype.toggleSearch=function(){var t=this.plugin.core.getState()[this.plugin.stateId],e=document.querySelector(".Browser-searchInput");this.updateState(_extends({},t,{isSearchVisible:!t.isSearchVisible,filterInput:""})),e.value="",t.isSearchVisible||e.focus()},t.prototype.filterItems=function(t){var e=this,i=this.plugin.core.getState()[this.plugin.stateId];return t.filter(function(t){return-1!==e.plugin.getItemName(t).toLowerCase().indexOf(i.filterInput.toLowerCase())})},t.prototype.sortByTitle=function(){var t=this,e=_extends({},this.plugin.core.getState()[this.plugin.stateId]),i=e.files,r=e.folders,n=e.sorting,s=i.sort(function(e,i){return"titleDescending"===n?t.plugin.getItemName(i).localeCompare(t.plugin.getItemName(e)):t.plugin.getItemName(e).localeCompare(t.plugin.getItemName(i))}),o=r.sort(function(e,i){return"titleDescending"===n?t.plugin.getItemName(i).localeCompare(t.plugin.getItemName(e)):t.plugin.getItemName(e).localeCompare(t.plugin.getItemName(i))});this.updateState(_extends({},e,{files:s,folders:o,sorting:"titleDescending"===n?"titleAscending":"titleDescending"}))},t.prototype.sortByDate=function(){var t=this,e=_extends({},this.plugin.core.getState()[this.plugin.stateId]),i=e.files,r=e.folders,n=e.sorting,s=i.sort(function(e,i){var r=new Date(t.plugin.getItemModifiedDate(e)),s=new Date(t.plugin.getItemModifiedDate(i));return"dateDescending"===n?r>s?-1:r<s?1:0:r>s?1:r<s?-1:0}),o=r.sort(function(e,i){var r=new Date(t.plugin.getItemModifiedDate(e)),s=new Date(t.plugin.getItemModifiedDate(i));return"dateDescending"===n?r>s?-1:r<s?1:0:r>s?1:r<s?-1:0});this.updateState(_extends({},e,{files:s,folders:o,sorting:"dateDescending"===n?"dateAscending":"dateDescending"}))},t.prototype.isActiveRow=function(t){return this.plugin.core.getState()[this.plugin.stateId].activeRow===this.plugin.getItemId(t)},t.prototype.handleDemoAuth=function(){var t=this.plugin.core.getState()[this.plugin.stateId];this.updateState({},t,{authenticated:!0})},t.prototype.handleAuth=function(){var t=this,e=Math.floor(999999*Math.random())+1,i=location.href+(location.search?"&":"?")+"id="+e,r=btoa(JSON.stringify({redirect:i})),n=this.plugin.opts.host+"/connect/"+this.Provider.authProvider+"?state="+r,s=window.open(n,"_blank");!function e(){var r=void 0;try{r=s.location.href}catch(t){if(t instanceof DOMException||t instanceof TypeError)return setTimeout(e,100);throw t}r.split("#")[0]===i?(s.close(),t._loaderWrapper(t.Provider.auth(),t.plugin.onAuth,t.handleError)):setTimeout(e,100)}()},t.prototype.handleError=function(t){var e=this.plugin.core,i=e.opts.debug?t.toString():e.i18n("uppyServerError");e.emit("informer",i,"error",5e3)},t.prototype.handleScroll=function(t){var e=this,i=t.target.scrollHeight-(t.target.scrollTop+t.target.offsetHeight),r=this.plugin.getNextPagePath?this.plugin.getNextPagePath():null;i<50&&r&&!this._isHandlingScroll&&(this.Provider.list(r).then(function(t){var i=e.plugin.core.getState()[e.plugin.stateId],r=i.files,n=i.folders;e._updateFilesAndFolders(t,r,n)}).catch(this.handleError).then(function(){e._isHandlingScroll=!1}),this._isHandlingScroll=!0)},t.prototype._loaderWrapper=function(t,e,i){var r=this;t.then(e).catch(i).then(function(){return r.updateState({loading:!1})}),this.updateState({loading:!0})},t.prototype.render=function(t){var e=t[this.plugin.stateId],i=e.authenticated;if(e.loading)return LoaderView();if(!i)return AuthView({pluginName:this.plugin.title,demo:this.plugin.opts.demo,handleAuth:this.handleAuth,handleDemoAuth:this.handleDemoAuth});var r=_extends({},t[this.plugin.stateId],{getNextFolder:this.getNextFolder,getFolder:this.getFolder,addFile:this.addFile,filterItems:this.filterItems,filterQuery:this.filterQuery,toggleSearch:this.toggleSearch,sortByTitle:this.sortByTitle,sortByDate:this.sortByDate,logout:this.logout,demo:this.plugin.opts.demo,isActiveRow:this.isActiveRow,getItemName:this.plugin.getItemName,getItemIcon:this.plugin.getItemIcon,handleScroll:this.handleScroll,title:this.plugin.title,viewType:this.opts.viewType});return Browser(r)},t}();
...
"use strict";var _appendChild=require("yo-yoify/lib/appendChild"),_svgNamespace="http://www.w3.org/2000/svg",_require=require("../../core/Utils"),getETA=_require.getETA,getSpeed=_require.getSpeed,prettyETA=_require.prettyETA,getFileNameAndExtension=_require.getFileNameAndExtension,truncateString=_require.truncateString,copyToClipboard=_require.copyToClipboard,prettyBytes=require("prettier-bytes"),FileItemProgress=require("./FileItemProgress"),getFileTypeIcon=require("./getFileTypeIcon"),_require2=require("./icons"),iconEdit=_require2.iconEdit,iconCopy=_require2.iconCopy;module.exports=function(e){var t,i,r,s,a,n,p,l,o,d,u,c,m,b,g,A,y,h,E,_,C,v,I,S,U,f,F,D=e.file,N=e.acquirers,q=D.progress.uploadComplete,w=D.progress.uploadStarted,T=D.progress.uploadStarted&&!D.progress.uploadComplete,k=D.isPaused||!1,L=getFileNameAndExtension(D.meta.name)[0],x=e.isWide?truncateString(L,15):L;return d=document.createElement("li"),d.setAttribute("id","uppy_"+String(D.id)),d.setAttribute("title",""+String(D.meta.name)),d.setAttribute("class","UppyDashboardItem\n                        "+String(T?"is-inprogress":"")+"\n                        "+String(q?"is-complete":"")+"\n                        "+String(k?"is-paused":"")+"\n                        "+String(e.resumableUploads?"is-resumable":"")),_appendChild(d,[" ",(s=document.createElement("div"),s.setAttribute("class","UppyDashboardItem-preview"),_appendChild(s,[" ",D.source?(u=document.createElement("div"),u.setAttribute("class","UppyDashboardItem-sourceIcon"),_appendChild(u,[" ",N.map(function(e){var t;if(e.id===D.source)return t=document.createElement("span"),t.setAttribute("title",""+String(e.name)),_appendChild(t,[e.icon()]),t})," "]),u):""," ",(t=document.createElement("div"),t.setAttribute("style","background-color: "+String(getFileTypeIcon(D.type.general,D.type.specific).color)),t.setAttribute("class","UppyDashboardItem-previewInnerWrap"),_appendChild(t,[" ",D.preview?(c=document.createElement("img"),c.setAttribute("alt",""+String(D.name)),c.setAttribute("src",""+String(D.preview)),c):(h=document.createElement("div"),h.setAttribute("class","UppyDashboardItem-previewIconWrap"),_appendChild(h,[" ",(m=document.createElement("span"),m.setAttribute("style","color: "+String(getFileTypeIcon(D.type.general,D.type.specific).color)),m.setAttribute("class","UppyDashboardItem-previewIcon"),_appendChild(m,[getFileTypeIcon(D.type.general,D.type.specific).icon]),m)," ",(y=document.createElementNS(_svgNamespace,"svg"),y.setAttribute("width","72"),y.setAttribute("height","93"),y.setAttribute("viewBox","0 0 72 93"),y.setAttribute("class","UppyDashboardItem-previewIconBg"),_appendChild(y,[(A=document.createElementNS(_svgNamespace,"g"),_appendChild(A,[(b=document.createElementNS(_svgNamespace,"path"),b.setAttribute("d","M24.08 5h38.922A2.997 2.997 0 0 1 66 8.003v74.994A2.997 2.997 0 0 1 63.004 86H8.996A2.998 2.998 0 0 1 6 83.01V22.234L24.08 5z"),b.setAttribute("fill","#FFF"),b),(g=document.createElementNS(_svgNamespace,"path"),g.setAttribute("d","M24 5L6 22.248h15.007A2.995 2.995 0 0 0 24 19.244V5z"),g.setAttribute("fill","#E4E4E4"),g)]),A)]),y)," "]),h)," "]),t)," ",(r=document.createElement("div"),r.setAttribute("class","UppyDashboardItem-progress"),_appendChild(r,[" ",(i=document.createElement("button"),i.setAttribute("type","button"),i.setAttribute("title",""+String(q?"upload complete":e.resumableUploads?D.isPaused?"resume upload":"pause upload":"cancel upload")),i.onclick=function(t){q||(e.resumableUploads?e.pauseUpload(D.id):e.cancelUpload(D.id))},i.setAttribute("class","UppyDashboardItem-progressBtn"),_appendChild(i,[" ",FileItemProgress({progress:D.progress.percentage,fileID:D.id})," "]),i)," ",e.showProgressDetails?(E=document.createElement("div"),E.setAttribute("title",""+String(e.i18n("fileProgress"))),E.setAttribute("aria-label",""+String(e.i18n("fileProgress"))),E.setAttribute("class","UppyDashboardItem-progressInfo"),_appendChild(E,[" ",D.isPaused||q?null:(_=document.createElement("span"),_appendChild(_,[prettyETA(getETA(D.progress))," ・ ↑ ",prettyBytes(getSpeed(D.progress)),"/s"]),_)," "]),E):null," "]),r)," "]),s)," ",(l=document.createElement("div"),l.setAttribute("class","UppyDashboardItem-info"),_appendChild(l,[" ",(a=document.createElement("h4"),a.setAttribute("title",""+String(L)),a.setAttribute("class","UppyDashboardItem-name"),_appendChild(a,[" ",D.uploadURL?(C=document.createElement("a"),C.setAttribute("href",""+String(D.uploadURL)),C.setAttribute("target","_blank"),_appendChild(C,[" ",D.extension?x+"."+D.extension:x," "]),C):D.extension?x+"."+D.extension:x," "]),a)," ",(p=document.createElement("div"),p.setAttribute("class","UppyDashboardItem-status"),_appendChild(p,[" ",(n=document.createElement("span"),n.setAttribute("class","UppyDashboardItem-statusSize"),_appendChild(n,[D.data.size?prettyBytes(D.data.size):""]),n)," "]),p)," ",w?null:(v=document.createElement("button"),v.setAttribute("type","button"),v.setAttribute("aria-label","Edit file"),v.setAttribute("title","Edit file"),v.onclick=function(t){return e.showFileCard(D.id)},v.setAttribute("class","UppyDashboardItem-edit"),_appendChild(v,[" ",iconEdit()]),v)," ",D.uploadURL?(I=document.createElement("button"),I.setAttribute("type","button"),I.setAttribute("aria-label","Copy link"),I.setAttribute("title","Copy link"),I.onclick=function(){copyToClipboard(D.uploadURL,e.i18n("copyLinkToClipboardFallback")).then(function(){e.log("Link copied to clipboard."),e.info(e.i18n("copyLinkToClipboardSuccess"),"info",3e3)}).catch(e.log)},I.setAttribute("class","UppyDashboardItem-copyLink"),_appendChild(I,[iconCopy()]),I):null," "]),l)," ",(o=document.createElement("div"),o.setAttribute("class","UppyDashboardItem-action"),_appendChild(o,[" ",q?null:(F=document.createElement("button"),F.setAttribute("type","button"),F.setAttribute("aria-label","Remove file"),F.setAttribute("title","Remove file"),F.onclick=function(){return e.removeFile(D.id)},F.setAttribute("class","UppyDashboardItem-remove"),_appendChild(F,[" ",(f=document.createElementNS(_svgNamespace,"svg"),f.setAttribute("width","22"),f.setAttribute("height","21"),f.setAttribute("viewBox","0 0 18 17"),f.setAttribute("class","UppyIcon"),_appendChild(f,[" ",(S=document.createElementNS(_svgNamespace,"ellipse"),S.setAttribute("cx","8.62"),S.setAttribute("cy","8.383"),S.setAttribute("rx","8.62"),S.setAttribute("ry","8.383"),S)," ",(U=document.createElementNS(_svgNamespace,"path"),U.setAttribute("stroke","#FFF"),U.setAttribute("fill","#FFF"),U.setAttribute("d","M11 6.147L10.85 6 8.5 8.284 6.15 6 6 6.147 8.35 8.43 6 10.717l.15.146L8.5 8.578l2.35 2.284.15-.146L8.65 8.43z"),U)," "]),f)," "]),F)," "]),o)," "]),d};
